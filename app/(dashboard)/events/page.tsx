  ...
  return (
    <div className="space-y-8">
      ...
      <PageHeader
        ...
        description="Test an event and follow its progress from trigger to email delivery."
      >
        {canSimulate && (
          <Button
            ...
            <div className="divide-y divide-border/30">
              {eventsData.data.map((event) => (
                <button
                  ...
                  className="flex w-full flex-col items-start justify-between gap-3 p-5 text-left transition-colors hover:bg-muted/50 sm:flex-row sm:items-center"
                >

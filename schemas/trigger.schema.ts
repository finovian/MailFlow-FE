...
export const conditionGroupSchema: z.ZodType<ConditionGroup> = z.lazy(() =>
  z.object({
    ...
    rules: z
      .array(z.lazy(() => z.union([conditionRuleSchema, conditionGroupSchema])))
      .default([]),
  }),
);
...
const baseCreateTriggerSchema = z.object({
  ...
  conditions: conditionGroupSchema
    .optional()
    .default({ operator: "AND", rules: [] }) as any,
  templateId: z.string().min(1, "Template is required"),
  recipientField: z.string().min(1, "Recipient field is required"),
  cooldownDays: z
    .number()
    .min(0, "Cooldown must be 0 or greater")
    .optional()
    .default(0),
...
export const createTriggerSchema =
  baseCreateTriggerSchema as unknown as z.ZodType<CreateTriggerDto>;

export type CreateTriggerFormValues = CreateTriggerDto;

export const updateTriggerSchema =
  baseCreateTriggerSchema.partial() as unknown as z.ZodType<UpdateTriggerDto>;

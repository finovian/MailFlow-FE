...
export function Sidebar() {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-30 flex flex-col border-r border-border/50 bg-card transition-all duration-300 ease-in-out",
          ...
          {NAV_ITEMS.map((item) => {
            ...
            const linkContent = (
              <Link
                ...
                className={cn(
                  "group flex items-center min-h-11 rounded-lg px-3 py-2.5 text-sm font-medium transition-all duration-150",
                  isActive
                    ? "bg-primary/7 text-primary ring-1 ring-primary/10"

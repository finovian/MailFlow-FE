...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      >
        {/* Top Bar */}
        <header className="sticky top-0 z-20 flex h-16 shrink-0 items-center border-b border-border/50 bg-card/95 px-4 backdrop-blur-xl sm:px-6">
          {/* Mobile menu toggle */}
          <Button
            variant="ghost"
            size="icon-sm"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  className="h-11 gap-2.5 rounded-xl border-border px-2.5 text-sm hover:bg-muted"
                >
                  ...
                  <span className="hidden max-w-44 truncate text-left sm:block">
        ...
        {/* Page Content */}
        <main className="mx-auto w-full min-w-0 max-w-[1440px] flex-1 px-4 py-6 sm:px-6 sm:py-8 lg:px-10">
          {children}
        </main>
      </div>
    </div>

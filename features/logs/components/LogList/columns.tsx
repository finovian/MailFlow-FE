...
export const logColumns: ColumnDef<SendLog>[] = [
  {
    ...
    sortable: true,
    cell: (row) => (
      <span className="font-medium text-foreground">{row.recipient}</span>
    ),
  },
  {
    id: "triggerName",
  ...
  },
  {
    ...
    sortable: true,
    cell: (row) => (
      <span className="font-mono text-xs text-muted-foreground bg-zinc-100 dark:bg-zinc-800/40 px-1 py-0.5 rounded">
        {row.eventType}
      </span>
    ),
  },
